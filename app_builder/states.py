...
class Plan(BaseModel):
    ...
    techstack: str = Field(
        description="The tech stack to be used for the app, e.g. 'requirements.txt','python', 'javascript', 'react', 'flask', etc.")
...
class AppState(BaseModel):
    ...
    coder_state: Optional[dict] = None
    reviewer_state: Optional[dict] = None
    coder_status: Optional[str] = None
